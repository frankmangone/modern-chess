...
mod tests {
    ...
    fn test_transform_record_has_promotion() {
        ...
        game.state
            .pieces
            .retain(|_, p| p.player == "WHITE" || p.player == "BLACK");
        ...
        game.state
            .pieces
            .insert(vec![0, 6], Piece::new("PAWN".into(), "WHITE".into()));
        game.state
            .pieces
            .insert(vec![7, 7], Piece::new("KING".into(), "WHITE".into()));
        game.state
            .pieces
            .insert(vec![7, 0], Piece::new("KING".into(), "BLACK".into()));
        ...
        // Resolve promotion.
        game.transition(GameTransition::Transform {
            target: "QUEEN".into(),
        })
        .unwrap();
