...
mod tests {
    ...
    fn test_uint_flag_decrements_each_tick() {
        ...
        game.state
            ...
            .unwrap()
            .state
            .insert("FLAG".to_string(), PieceState::Uint(2));
    ...
    fn test_duration_one_flag_available_for_one_turn_then_gone() {
        ...
        game.state
            ...
            .unwrap()
            .state
            .insert("EN_PASSANT".to_string(), PieceState::Uint(1));
    ...
    fn test_blank_flag_is_permanent() {
        ...
        game.state
            ...
            .unwrap()
            .state
            .insert("PERMANENT".to_string(), PieceState::Blank);
    ...
    fn test_string_flag_is_permanent() {
        ...
        game.state
            ...
            .insert(
                "LABEL".to_string(),
                PieceState::String("some_value".to_string()),
            );
    ...
    fn test_multiple_flags_expire_independently() {
        ...
        assert!(
            !state.contains_key("SHORT"),
            "SHORT should be gone after 2 ticks"
        );
        assert!(
            state.contains_key("LONG"),
            "LONG should still be present after 2 ticks"
        );
        ...
        assert!(
            !state.contains_key("LONG"),
            "LONG should be gone after 4 ticks"
        );
        assert!(state.contains_key("PERM"), "PERM should still be present");
    }
}
